  ...
  return (
    <div className="my-24 w-full mx-auto">
      <div className="flex md:flex-row flex-col gap-5 md:gap-0 items-center justify-between mb-12">
        <h1 className="w-1/3 capitalize text-3xl font-semibold text-nowrap flex justify-center md:block">
          {type} Product
        </h1>
      ...
      <div className="grid xl:grid-cols-4 lg:grid-cols-3 grid-cols-2 sm:gap-16 gap-8 relative min-h-36 ">
        {error ? (
          <ErroMsg />
        ) : loading ? (
          <Spinner />
